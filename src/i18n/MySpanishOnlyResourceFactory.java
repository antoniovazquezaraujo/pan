...
public class MySpanishOnlyResourceFactory extends ResourcesFactory {
  ...
  public MySpanishOnlyResourceFactory(String currencySymbol,Properties additionalDictionary,boolean showResourceNotFoundWarning) {
    ...
    dictionary.setProperty("Password","Contraseña");
    ...
    // server...
    dictionary.setProperty("Client request not supported","La petición del cliente no es soportada");
    dictionary.setProperty("User disconnected","Usuario desconectado");
    dictionary.setProperty("Updating not performed: the record was previously updated.","No se ha hecho la actualización: el registro habia sido actualizado con anterioridad.");
